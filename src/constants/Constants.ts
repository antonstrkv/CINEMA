...
export const DEFAULT_AUTHORIZATION_STATUS: any = JSON.parse(sessionStorage.getItem('isAuthorized') || 'false');

export const DEFAULT_FAVORITE_LIST: any = JSON.parse(localStorage.getItem('favoriteFilms') || '[]')
.sort((a: any, b: any) => a.popularity < b.popularity ? 1 : -1);
	
export const DEFAULT_TO_READ_LIST: any = JSON.parse(localStorage.getItem('toReadFilms') || '[]')
.sort((a: any, b: any) => a.popularity < b.popularity ? 1 : -1);
